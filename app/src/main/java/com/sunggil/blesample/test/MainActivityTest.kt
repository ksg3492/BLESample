...
class MainActivityTest : AppCompatActivity() , PlayerCallback {
    ...
    lateinit var vmMainViewModel : MainViewModelTest
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        vmMainViewModel = ViewModelProvider(this).get(MainViewModelTest::class.java)
        ...
        adapterMelon = AdapterMelon(object : OnItemClickCallback {
            override fun onClick(position: Int) {
                ...
                Thread{
                    ...
                    val ble =
                        BLEProtocol(AppConst.CLIENT_TO_SERVER.GET_MELON_STREAMING)
...
//            }
        ...
        bt_chart.setOnClickListener {
            ...
            val ble =
                BLEProtocol(AppConst.CLIENT_TO_SERVER.GET_MELON_CHART_LIST)
            ble.arg1 = 0
...
//                bindPlayerServiceServer()
    ...
    fun bindPlayerServiceMediaPlayer() {
        if (!mBound) {
            val intent = Intent(applicationContext, ExoPlayerServiceMediaPlayerTest::class.java)
                                ...
                                call.enqueue(object : Callback<MelonDomain> {
                                    override fun onResponse(
                                        ...
                                        if (response.body() != null && response.body()!!.content != null) {
                                            ...
                                            //image 가공
                                            thumbsTransferThread =
                                                ThumbsTransferThread(
                                                    baseContext,
                                                    items,
                                                    object :
                                                        ThumbsTransferThread.ThumbsListener {
                                        ...
                                        override fun onSuccess(item: MelonStreamingItem) {
                                            ...
                                            vmMainViewModel.downloadStreamingFile(name, item.PATH, object : DownloadCallback {
                                                ...
                                                override fun onUpdate(data: ByteArray, read: Int, length: Long) {
                                                    ...
                                                    ble.content = data
                                                    ble.contentLength = count    //별도로 입력
                                                    write(ble)
                                                    count++
                                                }
                                            })
...
//                        prepareLogcat = System.currentTimeMillis()
                            ...
                            val count = bleProtocol.contentLength
